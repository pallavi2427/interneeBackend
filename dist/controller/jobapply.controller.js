...
class JobApplyController {
    static jobApply(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const existingLink = yield jobapply_model_1.JobApplyModel.findOne({
                    where: { job_id: job_id, student_id: student_id },
                });
                if (!existingLink) {
                    const std = yield jobapply_model_1.JobApplyModel.create({
                        job_id: job_id,
    ...
    static allstudentJob(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { student_id } = req.query;
            try {
                const data3 = yield jobapply_model_1.JobApplyModel.sequelize.query(`SELECT 
